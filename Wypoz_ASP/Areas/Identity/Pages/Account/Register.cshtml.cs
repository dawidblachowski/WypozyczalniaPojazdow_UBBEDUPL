...
namespace Wypoz_ASP.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [DataType(DataType.Text)]
            [Display(Name = "AddressApartmentNumber Number")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.AddressFlatNumber = Input.AddressApartmentNumber;
                user.AddressPostalCode = Input.AddressZipCode;
